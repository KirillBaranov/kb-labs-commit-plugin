...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@ant-design/icons": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild___mf_0_ant_mf_2_design_mf_1_icons__prebuild__.js");
            return pkg;
        }
      ,
        "@kb-labs/studio-event-bus": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild___mf_0_kb_mf_2_labs_mf_1_studio_mf_2_event_mf_2_bus__prebuild__.js");
            return pkg;
        }
      ,
        "@kb-labs/studio-hooks": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild___mf_0_kb_mf_2_labs_mf_1_studio_mf_2_hooks__prebuild__.js");
            return pkg;
        }
      ,
        "@kb-labs/studio-ui-core": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild___mf_0_kb_mf_2_labs_mf_1_studio_mf_2_ui_mf_2_core__prebuild__.js");
            return pkg;
        }
      ,
        "@kb-labs/studio-ui-kit": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild___mf_0_kb_mf_2_labs_mf_1_studio_mf_2_ui_mf_2_kit__prebuild__.js");
            return pkg;
        }
      ,
        "@tanstack/react-query": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild___mf_0_tanstack_mf_1_react_mf_2_query__prebuild__.js");
            return pkg;
        }
      ,
        "antd": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild__antd__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild__react__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ,
        "react-router-dom": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild__react_mf_2_router_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ,
        "zustand": async () => {
          let pkg = await import("__mf__virtual/commitPlugin__prebuild__zustand__prebuild__.js");
            return pkg;
        }
